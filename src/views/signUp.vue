<template>
	<div class="ecm-signIn-wrap" ref="element">
		<div class="ecm-form">
			<mt-field placeholder="请输入用户名" v-model="userName" type="text" class="ecm-account-input"></mt-field>
			...
			<p class="ecm-signIn-link">已有账号？<router-link class="float-right" to="/signIn">登陆</router-link></p>
			<mt-button type="primary" size="large" class="ecm-signIn-btn" @click="signUp()">注册</mt-button>
		</div>
	</div>	
</template>
<script>
